...
class Player:
    def __init__(self, first_dir="odyssee"):
        ...
        self.directory_names = {
            "odyssee": ("/home/pi/Music/Odyssee", "./odyssee.mp3"),
            "olma": ("/home/pi/Music/Olma", "./olma.mp3"),
            "lesoldatrose": ("/home/pi/Music/LeSoldatRose", "./SoldatRose.mp3"),
        }
    ...
    def _next_dir(self):
        keys = list(self.directory_names.keys())
    ...
    def run(self):
        ...
        button_milieu = Button(2, hold_time=2)
